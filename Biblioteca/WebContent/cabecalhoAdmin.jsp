...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/Biblioteca/font-awesome.min.css" />
	  ...
	  <div class="container">
	    ...
	    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
	      <ul class="nav navbar-nav">
	        <li><a class="btn btn-success btn-lg" href="/Biblioteca/usuarios.jsp">Usuarios</a></li>
	        <li><a class="btn btn-warning btn-lg" href="/Biblioteca/livros.jsp">Livros</a></li>
